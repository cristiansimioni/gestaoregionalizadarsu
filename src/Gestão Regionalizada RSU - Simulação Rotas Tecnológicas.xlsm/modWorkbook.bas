...
Public Sub EditToolTwoData(ByVal filename, ByVal routeFiles, ByVal arr, ByVal market As String)
    ...
    ' Valores sub-arranjo
    ActiveWorkbook.Sheets("RESUMO GERAL Valoriz. RT큦").range("C30") = arr.vInbound
    ActiveWorkbook.Sheets("RESUMO GERAL Valoriz. RT큦").range("C31") = arr.vOutbound
    
    If market = FOLDERLANDFILLMARKET Then
        ActiveWorkbook.Sheets("RESUMO GERAL Valoriz. RT큦").range("C31") = arr.vOutboundExistentLandfill
    End If
