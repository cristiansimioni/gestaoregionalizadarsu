...
def inboundoutbound(cdata, distance, subarray, isCentralized, utvrs_only, aterros_only, existentlandfill, CAPEX_INBOUND, CAPEX_OUTBOUND, PAYMENT_PERIOD, MOVIMENTATION_COST, LANDFILL_DEVIATION, totalTrash):
    ...
    for utvr_city in subarray:
        ...
        if utvr_city in utvrs_only:
            ...
            sum_inbound = round((capexInbound*(getSubTrash(cdata, subarray)/totalTrash)) + sum_inbound, 3)
            ...
            for a in existentlandfill:
                ...
                if distCities < dist:
                    ...
                    entry["outbound-existente"] = round((capexOutbound*(getSubTrash(cdata, subarray)/totalTrash)) + sum_outbound, 3)
            ...
            for a in aterros_only:
                ...
                e["aterro"] = a
                e["outbound"] = round((capexOutbound*(getSubTrash(cdata, subarray)/totalTrash)) + sum_outbound, 3)
...
def main():
    ...
    for i in new_comb:
        ...
        for y in i:
            ...
            rsinout = inboundoutbound(citiesdic, distance, y, centralizado, utvrs, landfill, existentlandfill, CAPEX_INBOUND, CAPEX_OUTBOUND, PAYMENT_PERIOD, MOVIMENTATION_COST, LANDFILL_DEVIATION, totalTrash)
